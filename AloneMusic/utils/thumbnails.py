...
async def get_thumb(videoid):
    ...
    try:
        ...
        color_overlay = Image.new(
            "RGBA", bg.size, (accent[0], accent[1], accent[2], 140)
        )
        ...
        glass_pos = (
            (bg.width - glass.width) // 2,
            (bg.height - glass.height) // 2 - 10,
        )
        ...
        glow = Image.new(
            "RGBA", glow_size, (bar_color[0], bar_color[1], bar_color[2], 80)
        )
        ...
        font_brand = (
            safe_font("ShrutixMusic/assets.font.ttf", 40)
            if False
